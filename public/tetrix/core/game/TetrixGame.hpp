...
namespace tetrix
{
    ...
    namespace core
    {
        ...
        private:
            ...
            TetrixGame(const TetrixGame&)            = delete;
            TetrixGame& operator=(const TetrixGame&) = delete;
            TetrixGame(TetrixGame&&)                 = delete;
...
using tetrixGame = tetrix::core::TetrixGame;
